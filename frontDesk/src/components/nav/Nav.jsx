...
export default function Nav(){
    ...
    <nav className={styles.navCont}>
        ...
        <div className={styles.navLinksCont}>
            ...
            <NavLink to='/bill' className={styles.navLink}><i class="fa-solid fa-money-check-dollar"></i><span className={styles.navItem}>Bill</span></NavLink>
            ...
            <NavLink to='/payment' className={styles.navLink}><i class="fa-solid fa-file-lines"></i><span className={styles.navItem}>Payments</span></NavLink>
        </div>
    </nav>
    )
}